...
import com.rubinho.shishki.rest.v1.BookingApiV1;
...
@RestController
public class BookingApiV1Impl implements BookingApiV1 {
    private final BookingService bookingService;
    private final AccountService accountService;

    @Autowired
    public BookingApiV1Impl(BookingService bookingService,
