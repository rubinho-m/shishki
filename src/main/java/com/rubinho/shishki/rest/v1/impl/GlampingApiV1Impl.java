...
import com.rubinho.shishki.rest.v1.GlampingApiV1;
...
@RestController
public class GlampingApiV1Impl implements GlampingApiV1 {
    private final GlampingService glampingService;
    private final AccountService accountService;
    private final PhotoService photoService;

    @Autowired
    public GlampingApiV1Impl(GlampingService glampingService,
