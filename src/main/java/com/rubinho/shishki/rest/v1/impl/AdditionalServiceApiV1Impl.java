...
import com.rubinho.shishki.rest.v1.AdditionalServiceApiV1;
...
@RestController
public class AdditionalServiceApiV1Impl implements AdditionalServiceApiV1 {
    private final AdditionalServiceService additionalServiceService;

    @Autowired
    public AdditionalServiceApiV1Impl(AdditionalServiceService additionalServiceService) {
