...
import com.rubinho.shishki.rest.v1.ShopItemApiV1;
...
@RestController
public class ShopItemApiV1Impl implements ShopItemApiV1 {
    private final ShopItemService shopItemService;

    @Autowired
    public ShopItemApiV1Impl(ShopItemService shopItemService) {
