...
VALUES ('Михаил', 'Рубин', '+7-123-456-78-90', 'test@vk.ru'),
       ...
       ('Василий', 'Васильев', '+7-912-812-10-20', 'guest1@vk.com'),
       ('Иван', 'Иванов', '+7-923-812-10-20', 'guest2@vk.com');
...
VALUES ('admin', '$2a$10$KgOvtVlh.KZkxKbLsPmDJOPPvCxguGgstDSMHqxFVYYxcygeflnvC', 1, 'ADMIN'),
       ('staff', '$2a$10$KgOvtVlh.KZkxKbLsPmDJOPPvCxguGgstDSMHqxFVYYxcygeflnvC', 3, 'STAFF'),
       ('user', '$2a$10$KgOvtVlh.KZkxKbLsPmDJOPPvCxguGgstDSMHqxFVYYxcygeflnvC', 4, 'USER');
...
VALUES (3, 2, 2828, '2025-11-05', '2025-11-07');
